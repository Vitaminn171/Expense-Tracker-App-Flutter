...
class AddRevenueWidget extends StatefulWidget {
  const AddRevenueWidget({super.key});

  @override
  State<AddRevenueWidget> createState() => _AddRevenueWidgetState();
}

class _AddRevenueWidgetState extends State<AddRevenueWidget> {
  late AddRevenueModel _model;
  late AddRevenueViewModel _viewModel;
  double _heightContainer = 370;
  late DateTime _selectedDate;

  TagItem _tagItemSelected = Utils.tagRevenue.first;
  bool isAdded = false;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddRevenueModel());

    _viewModel = Provider.of<AddRevenueViewModel>(context, listen: false);
  ...
  void dispose() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      _viewModel.revenueProvider.setListTransactionsDetail([]);
      _viewModel.revenueProvider.setRevenueEdit(null);
    });
  ...
  void _clearDataTextField() {
    ...
    _tagItemSelected = Utils.tagRevenue.first;
  }
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Consumer<RevenueProvider>(builder: (context, myState, child) {
                                                                ...
                                                                return InputDecorator(
                                                                  ...
                                                                  child: DropdownButtonHideUnderline(
                                                                    child: DropdownButton<TagItem>(
                                                                      ...
                                                                      items: Utils.tagRevenue.map<DropdownMenuItem<TagItem>>((TagItem value) {
