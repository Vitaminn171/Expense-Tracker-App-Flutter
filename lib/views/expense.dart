...
class _ExpenseListWidgetState extends State<ExpenseListWidget> {
  ...
  Future<List<Transactions>> _fetchData(DateTimeRange dateRange) async {
    return _viewModel
        .getExpDateRange(dateRange); // Replace with your actual API call
  }
  ...
  void initState() {
    ...
    _selectedDateRange = _viewModel.getDateRange() ?? DateTimeRange(
  ...
  Future<void> fetchData(DateTimeRange picked) async {
    ...
    setState(() {
      datePicked =
          '${Utils.formatDatePicker(picked.start)} - ${Utils.formatDatePicker(picked.end)}';
    });
  }
        ...
        child: CustomPopscope(
          widget: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              ...
              enableFeedback: true,
              child: Icon(Icons.add_rounded, color: backgroundColor, size: 28,),
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: UserWidget(
                                            ...
                                            title:
                                                'Danh sách chi tiêu'), //'Danh sách chi tiêu'
                                      ),
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            25, 0, 25, 0),
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(0,
                                                                      10, 0, 0),
                                                          child: Text(
                                                            '\$${Utils.formatCurrency(snapshot.data!.toInt())}',
                                                            style: TextStyle(
                                                              fontFamily:
                                                                  'Montserrat',
                                                              fontSize: 27,
